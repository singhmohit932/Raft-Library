...
// Submit wraps the underlying rf's Submit; see that method for documentation.
func (s *Server) Submit(rfd any) int {
...
// RPCProxy is a pass-thru proxy server for Raft's RPC methods. It
// serves RPC requests made to a rf and manipulates them before forwarding to
// the rf itself.
//
